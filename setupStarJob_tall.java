...
public class setupStarJob_tall extends StarMacro {
  ...
  private void execute0() {
    ...
    Boundary boundary_7 = region_0.getBoundaryManager().getBoundary("Subtract.Default 2");
    boundary_7.setPresentationName("Building1");

    Boundary boundary_8 = region_0.getBoundaryManager().getBoundary("Subtract.Default");
    boundary_8.setPresentationName("Building2");

    Boundary boundary_9 = region_0.getBoundaryManager().getBoundary("Subtract.Default 3");
    boundary_9.setPresentationName("Building3");

    Boundary boundary_10 = region_0.getBoundaryManager().getBoundary("Subtract.Default 12");
    boundary_10.setPresentationName("Building4");

    Boundary boundary_11 = region_0.getBoundaryManager().getBoundary("Subtract.Default 8");
    boundary_11.setPresentationName("Building6");

    Boundary boundary_12 = region_0.getBoundaryManager().getBoundary("Subtract.Default 4");
    boundary_12.setPresentationName("Building5");
	
	Boundary boundary_13 = region_0.getBoundaryManager().getBoundary("Subtract.Default 5");
    boundary_13.setPresentationName("Building7");
	
	Boundary boundary_14 = region_0.getBoundaryManager().getBoundary("Subtract.Default 9");
    boundary_14.setPresentationName("Building8");
	
	Boundary boundary_15 = region_0.getBoundaryManager().getBoundary("Subtract.Default 6");
    boundary_15.setPresentationName("Building9");
	
	Boundary boundary_16 = region_0.getBoundaryManager().getBoundary("Subtract.Default 10");
    boundary_16.setPresentationName("Building10");
	
	Boundary boundary_17 = region_0.getBoundaryManager().getBoundary("Subtract.Default 7");
    boundary_17.setPresentationName("Building11");
	
	Boundary boundary_18 = region_0.getBoundaryManager().getBoundary("Subtract.Default 11");
    boundary_18.setPresentationName("Building12");
	
	// Reset region on probes
	List<String> buildings = Arrays.asList("b1", "b2", "b3", "b4", "b5", "b6", "b7", "b8", "b9", "b10", "b11", "b12");
	...
	// Reset region on periodic probes
	List<String> periodics = Arrays.asList("inlet_z=2h", "outlet_z=2h", "left_z=2h", "right_z=2h");
	for (String periodic : periodics) {
		LinePart linePart_1 = ((LinePart) simulation_0.getPartManager().getObject(periodic));
		linePart_1.getInputParts().setObjects(region_0);
	}
	...
	for (String scene_name : scene_names) {
		...
		scalarDisplayer_0.getInputParts().setObjects(boundary_7, boundary_8, boundary_9, boundary_10, boundary_12, boundary_11, boundary_3, boundary_13, boundary_14, boundary_15, boundary_16, boundary_17, boundary_18);
	}
	...
	meshDisplayer_0.getInputParts().setObjects(boundary_7, boundary_8, boundary_9, boundary_10, boundary_12, boundary_11, boundary_3, boundary_13, boundary_14, boundary_15, boundary_16, boundary_17, boundary_18);
    ...
    BoundaryInterface boundaryInterface_1 = simulation_0.getInterfaceManager().createBoundaryInterface(boundary_2, boundary_5, "Interface");
